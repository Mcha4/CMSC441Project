...
int main(){
    ...
    while(count < iteration){
        ...
        matrix E(matrixSize, matrixSize);//16
        matrix F(matrixSize, matrixSize);//32
        matrix G(matrixSize, matrixSize);//64
        matrix H(matrixSize, matrixSize);//128
        matrix I(matrixSize, matrixSize);//256
        ...
        dataTable.setData(count, 8, memoryBasic); //memoryBasic
